...
Visual fidelity comes first. The project should make Enfusion scenes feel physically convincing while retaining their authored identity. The first compelling demonstration must also be playable: 1440p at 20 FPS or better on the owner's RX 7800 XT. Other resolutions must work, with quality profiles that can later scale to other GPUs.
...
## First hardware envelope

| Quantity | Initial target or constraint |
| --- | --- |
| Reference GPU | AMD Radeon RX 7800 XT, nominal 16 GB VRAM |
...
| Development | This machine; no rented GPU or paid training yet |
