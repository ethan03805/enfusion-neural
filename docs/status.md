...
Next: a bounded source-preserving channel guard, checked against this unchanged replay and explicit saturation fixtures. The missing appearance target remains a separate blocker; fixing clipping cannot satisfy photorealism. The [roadmap](roadmap.md) fixes the correction's acceptance criteria. Blender studies remain [background research](research-history.md).
