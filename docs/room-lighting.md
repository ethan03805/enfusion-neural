...
The subsequent [point-light calibration](light-calibration.md) completes that fixed-exposure sweep with a separately rendered point-light fixture. Its frozen mapping fails seven of 22 reserved checks; all images and failures are retained. Further material/environment isolation is required before accepting a training pair. Supported scene inputs and output presentation remain a separate integration requirement.
