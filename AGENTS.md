...
- Keep raw captures, profiles, machine paths and game assets in ignored runs/ or experiments/local/. Commit reviewed summaries, hashes and original procedural fixtures only. Code licensing never grants rights to game content.
